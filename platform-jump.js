...
/*jslint devel: true, browser: true getset: true this: true*/
/*global window Audio*/

// CODE CREATED WITH THE HELP OF TUTORIAL AND SOURCECODE BY FRANK POTH
// @PothOnProgramming ON YOUTUBE
// VIDEO LINKS: https://youtu.be/hNV-xEMALr8 (sourcecode in discription)
            //  https://youtu.be/8uIt9a2XBrw (sourcecode in discription)
(function () {
    "use strict";
    ...
    function updateByID(element, update) {
        ...
        } else if (element === "loses") {
            byID(element).innerHTML = update;
        } else {
            console.log("Error: Unknown HTML element ID");
        }
    }
    ...
    function checkMobile() {
        if (byID("universe").clientWidth < byID("universe").clientHeight) {
            alert("Warning: Mobile is not supported");
        }
    }
